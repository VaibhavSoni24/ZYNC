...
export const AvatarIcon: React.FC<AvatarProps> = ({ name, size = 44, className = '', ...props }) => {
  ...
  const renderAvatar = (
    ...
    const clipId = `avatar-clip-${avatarName.toLowerCase()}`;
    return (
      <svg
        width={s}
        height={s}
      ...
      >
        ...
        {/* Clipped Character Artwork - Strictly contained inside the circular frame */}
        <g clipPath={`url(#${clipId})`}>
          {children}
        </g>

        {/* Outer Circular Border Ring On Top - Guarantees zero bleed */}
        <circle cx="50" cy="50" r="48" stroke={strokeColor} strokeWidth="2.5" fill="none" />
      </svg>
    );
  };
  ...
  switch (name) {
    ...
    case 'Comet':
      return renderAvatar('Comet', '#1E293B', '#38BDF8', (
        <>
          {/* Shoulders / Shirt */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#2563EB" />
    ...
    case 'Nova':
      return renderAvatar('Nova', '#2E1065', '#C084FC', (
        <>
          {/* Purple Afro Puffs */}
          ...
          {/* Shirt */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#9333EA" />
          {/* Head & Neck */}
    ...
    case 'Drift':
      return renderAvatar('Drift', '#0F172A', '#22D3EE', (
        <>
          {/* Hoodie */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#0891B2" />
    ...
    case 'Pulse':
      return renderAvatar('Pulse', '#3B0764', '#F43F5E', (
        <>
          ...
          {/* Shirt */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#E11D48" />
          {/* Head & Neck */}
    ...
    case 'Glint':
      return renderAvatar('Glint', '#020617', '#38BDF8', (
        <>
          {/* Futuristic Jacket */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#0F172A" />
          <path d="M 40 68 L 50 98 L 60 68" stroke="#38BDF8" strokeWidth="2" fill="none" />
          {/* Head & Neck */}
    ...
    case 'Ember':
      return renderAvatar('Ember', '#431407', '#FB923C', (
        <>
          {/* Jacket */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#C2410C" />
          {/* Head & Neck */}
    ...
    case 'Wisp':
      return renderAvatar('Wisp', '#064E3B', '#34D399', (
        <>
          {/* Oversized Mint Hoodie Hood Backdrop */}
          <path d="M 24 50 C 24 22, 76 22, 76 50 C 76 76, 24 76, 24 50 Z" fill="#059669" />
          {/* Shoulders */}
          <path d="M 16 98 C 20 70, 38 66, 50 66 C 62 66, 80 70, 84 98 Z" fill="#10B981" />
          {/* Head & Neck */}
    ...
    case 'Prism':
      return renderAvatar('Prism', '#3B0764', '#A855F7', (
        <>
          {/* High Collar Jacket */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#581C87" />
          {/* Head & Neck */}
    ...
    case 'Orbit':
    default:
      return renderAvatar('Orbit', '#0F172A', '#818CF8', (
        <>
          {/* Shoulders */}
          <path d="M 18 98 C 22 72, 40 68, 50 68 C 60 68, 78 72, 82 98 Z" fill="#3730A3" />
          {/* Head & Neck */}
